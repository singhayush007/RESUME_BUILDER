            ...
            <section>
              ...
              <div className="space-y-4">
                {data.project.map((project, index) => (
                  <div key={index} className="border-b border-zinc-300 pb-3">
                    ...
                    {project.description && (
                      <ul className="list-disc list-inside text-sm text-zinc-700 space-y-1 mb-1">
                    ...
                    <div className="flex flex-wrap gap-4 text-sm">
                      {project.githubLink && (
                        <a
                          ...
                          className="text-blue-600 hover:text-blue-800 transition-opacity"
